##############################################################################
#  Name        : CS210_Starter_PY_Code.py
#  Author      : Mark Baker
#  Version     :
#  Copyright   : 
#  Description : CS-210 Programming languages Project Three Python code
##############################################################################
...
def locate_Total_Product_Amount(v):
    ...
    tot_inventory = 0 #counts amount of times loop iterates
    tot_inventory_count = 0 # meant to hold total inventory in document file

    for word in unique_Product: # get total amount of items in list
    ...
    for word in unique_Product: #finds the element in unique_Product that is the requested string from user
        ...
        if (temp_String == v):
            ...
            tot_inventory -= 1 # this determines that the item was accessed at least once during iteration
